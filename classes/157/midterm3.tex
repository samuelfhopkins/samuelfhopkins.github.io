...
\title{Midterm \#3, 11/25 \\ Math 157 (Calculus II), Fall 2025}
\date{}
...
\begin{enumerate}
\item $\displaystyle \lim_{n\to \infty} \frac{4n^2-n-1}{2n^2+2n+1}$
\item $\displaystyle \lim_{n\to \infty} \sin(\frac{2\pi}{n})$
...
\begin{enumerate}
\item $\displaystyle \sum_{n=1}^{\infty} \frac{3n}{2n-1}$ \hfill ({\bf Hint}: check the limit of the terms.)
...
\item $\displaystyle \sum_{n=1}^{\infty} \frac{3^n+1}{4^n+1}$ \hfill ({\bf Hint:} look at the ratio of successive terms.)
\end{enumerate}
