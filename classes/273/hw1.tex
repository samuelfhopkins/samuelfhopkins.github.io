...
\[ \sum_{n \geq 0}  \left( \, \sum_{\sigma\in S_n} \prod_{i=1}^{n} t_i^{c_i(\sigma)} \, \right)  \frac{x^n}{n!} = e^{\sum_{j=1}^{\infty} t_j\frac{x^j}{j}},\]
where $c_i(\sigma)$ is the number of cycles of $\sigma$ of size $i$. How can you use this generating function to deduce this result?
