...
\title{Math 211 (Modern Algebra II), Midterm Exam, \\ {\normalsize Spring 2026; Instructor: Sam Hopkins; Taken on: Wednesday, March 4th}}
\date{}
...
\item Express $2u^2-u+1$ in your basis.
...
\item Does the polynomial $f(x) = x^3+9x \in \mathbb{R}[x]$ split over the real numbers $\mathbb{R}$? Explain what this means and why or why not. If it does not split over $\mathbb{R}$, then what is the smallest extension of $\mathbb{R}$ where it does split? Show \emph{how} it splits, either in $\mathbb{R}$ or in the extension.
