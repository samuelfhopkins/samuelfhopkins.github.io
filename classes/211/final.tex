...
\title{Math 211 (Modern Algebra II), Final Project, \\ {\normalsize Spring 2026; Instructor: Sam Hopkins; Presentation on: April 27th; Report due: April 29th}}
\date{}
...
For your final project, you will do independent research on a topic in algebra of your choosing, and then {\bf give a short presentation} and {\bf write a short report} about your topic. The presentation should be about 20 minutes long, with an additional 5 minutes for questions, and will take place in class on Monday, April 27th. The report should be about 4 pages, typed (preferably in LaTeX), with references, and is due on Wednesday, April 29th. For topics, you can pick one from the following list, or can come up with something else on your own. But please let me know what topic you choose, so that I can suggest some sources.
...
\item {\bf Representation theory of finite groups.} ``Representation theory'' is a basic idea in algebra where we ``represent'' some abstract algebraic structure in a more ``concrete'' way. For groups, this means representing an abstract group as a group of \emph{matrices}. You could choose this topic if you enjoyed our study of groups. Some results you could focus on for your project are the facts that, over the complex numbers, any finite-dimensional representation of a finite group is a direct sum of irreducible representations, and that for each such group, there are finitely many irreducible representations.
...
\item {\bf Further topics in field theory \& Galois theory.} If you enjoyed what we studied most recently, field theory and Galois theory, there are many further topics in this area that you could do a project on. For example, you could learn about the inverse Galois problem, which asks which finite groups are realizable as Galois groups of finite extensions of the rational numbers. Or you could explore origami (paper folding) - we saw how compass and straightedge constructions allow one to solve quadratic equations, and origami allows one to solve cubic equations as well.

\item {\bf Basic algebraic number theory.} Arithmetic properties of numbers, such as their being prime or more generally their prime factorizations, repeatedly came up in our study of basic algebraic structures like groups and rings. Conversely, number theoretic questions can often be attacked with algebra. Your project could be on a topic in algebraic number theory: e.g., the rings of integers of number fields, or the $p$-adic numbers.
