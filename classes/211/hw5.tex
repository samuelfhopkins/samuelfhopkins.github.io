...
\title{Math 211 (Modern Algebra II), HW\# 5, \\ {\normalsize Spring 2026; Instructor: Sam Hopkins; Due: Wednesday, April 8th}}
\date{}
...
\begin{enumerate}
    ...
    \item Conclude that $\mathrm{Aut}_K(K(x))$ consists exactly of the assignments $x \mapsto (ax+b)/(cx+d)$ with $a,b,c,d \in K$ and $ad - bc \neq 0$; moreover, these assignments are all distinct, up to multiplication of the $a,b,c,d$ by the same scalar constant $\lambda \in K^{\times}$. (These are called \emph{fractional linear transformations}, and can be viewed as invertible $2\times 2$ matrices with entries in $K$, modulo scalar multiples of the identity.)
\end{enumerate}
