...
\begin{enumerate}
\item ``indeterminate form'' $\displaystyle \lim_{x\to a} \frac{f(x)}{g(x)}$ means ``$\pm \frac{\infty}{\infty}$'' or ``$\frac{0}{0}$''
\item for indeterminate form limits, $\displaystyle \lim_{x\to a} \frac{f(x)}{g(x)} = \lim_{x\to a} \frac{f'(x)}{g'(x)}$
\end{enumerate}
