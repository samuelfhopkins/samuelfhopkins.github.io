...
\begin{enumerate}
\item definite integral $\int_{a}^{b} f(x) \; dx$ as area under the curve $y=f(x)$ from $x=a$ to $x=b$, or more precisely as limit of ``Riemann'' (rectangle) sums $\lim_{n \to \infty} \sum_{i=1}^{n} f(x^{*}_i) \Delta x$
